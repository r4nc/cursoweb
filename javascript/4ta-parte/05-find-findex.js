...
const firstNumberGreaterThan10 = multipleOf5.find(number => number > 10)// te da el valor o datos buscado
...
const indexNumber = randomNumber.findIndex(number => number > 50)// te da la posicion donde se encuentra el dato o valor 
